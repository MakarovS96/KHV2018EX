...
function getConfiguration(params) {
    if (params.namespace == undefined || params.namespace == null) params.namespace = "KHABSCHOOL";
    return {
...
function getReportBlocks(params) {
    ...
    return [{
        ...
        widget: {
            url: server + "/dsw/index.html#!/d/KHAB/Khabarovsk%20Map.dashboard?widget=1&height=420&isLegend=true&ns=" + namespace,
            width: 495,
            height: 420
        },
        totals: [{
        ...
        note: "",
        widget: {
            url: server + "/dsw/index.html#!/d/Report/Person.dashboard?widget=0&height=420&ns=" + namespace,
            width: 700,
            height: 420
        }
    }];
